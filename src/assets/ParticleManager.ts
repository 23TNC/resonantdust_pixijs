 ...
 */
export class ParticleManager extends LayoutNode {
  ...
  override destroy(): void {
    ...
    for (const entry of this._active) {
      ...
      // owned containers are children of this.container and destroyed by super.destroy()
    }
    this._active = [];
    super.destroy();
  }
