...
- `WorldView.ts`: thin re-export of `world/LayoutWorld` so the file path under `scenes/game/` stays parallel with the other views. The actual hex-grid renderer lives in [`../../world/AGENT.md`](../../world/AGENT.md).
