...
- `main/MainScene.ts`: post-login scene. Hosts the world view, inventory, blueprints, and details as independent PixiPanels managed by `ctx.panels` (PanelManager) — no browse/play modes. See [main/AGENTS.md](main/AGENTS.md).
